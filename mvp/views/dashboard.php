<div style="margin-bottom: 20px;">
    ...
    <div style="display: flex; gap: 20px; margin-bottom: 20px; flex-wrap: wrap;">
        <span style="padding: 8px 16px; background: #f8f9fa; border-radius: 4px; font-weight: 500;"><?php echo count($projects); ?> Matters</span>
        <span style="padding: 8px 16px; background: #f8f9fa; border-radius: 4px; font-weight: 500;"><?php echo count($clients); ?> Clients</span>
        <span style="padding: 8px 16px; background: #f8f9fa; border-radius: 4px; font-weight: 500;"><?php echo count($recentDocuments); ?> Documents</span>
    </div>
</div>
