<?php
$supportContact = htmlspecialchars(
    (string)(getenv('SUPPORT_EMAIL') ?: getenv('PDF_SIGNING_CONTACT') ?: 'support@example.com'),
    ENT_QUOTES,
    'UTF-8'
);
?>
...
<div class="panel">
    <p class="muted">For assistance, contact <a href="mailto:<?php echo $supportContact; ?>"><?php echo $supportContact; ?></a> or consult our quickstart image below.</p>
    <div>
