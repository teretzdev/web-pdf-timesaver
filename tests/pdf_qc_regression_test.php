...
final class PdfQualityControlRegressionTest extends TestCase {
	public function test_fl100_generation_has_background_and_reasonable_size(): void {
		...
		// Size threshold: background present outputs have historically been > 20KB; allow some margin.
		...
		// For each page, rasterize and assert image is not blank (background/text present)
		...
		// QC log should reflect that a background was applied or drawn
